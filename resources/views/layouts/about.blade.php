<!-- About Section -->
<section class="page-section dark-bg" id="about" >
        ...
        <div class="row product-list-row">
            ...
            <div class="col-12 col-md-6 list-one">
                <ul class="product-list">
                    ...
                    <li>QSFP28 SR4/LR4</li>
                    <li>SFP28 SR/LR/ER/BIDI/CWDM/DWDM</li>
                    <li>10G SFP+ SR/LR/ER/ZR/BIDI/CWDM/DWDM</li>
                    <li>10G XFP SR/LR/ER/ZR/BIDI/CWDM/DWDM</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 list-two">
                <ul class="product-list">
                    <li>CSFP/CSFP+</li>
                    <li>SFP/BIDI SFP/CWDM SFP/DWDM SFP</li>
                    <li>100G/40G/10G AOC </li>
                    <li>TOSA/ROSA/BOSA</li>
                    <li>Customized transceivers</li>
                </ul>
            </div>
        </div>
    </div>
